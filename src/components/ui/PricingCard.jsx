 ...
 */
const PricingCard = ({ title, description, price, features, buttonText, isHighlighted, onPlanChange, isMobile }) => {
  return (
    /* Container หลัก: ใช้ flex-col และ items-stretch เพื่อให้ทุกการ์ดสูงเท่ากันแม้เนื้อหาไม่เท่ากัน */
    <div className={`p-8 rounded-3xl border border-gray-100 flex flex-col gap-6 bg-white transition-all duration-300 ${
        ...
        {features.map((feature, index) => (
          <div key={index} className="flex items-center gap-3">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <ellipse cx="12" cy="11.9915" rx="12" ry="11.9915" fill="#E5F1FF"/>
              <path d="M18.0212 8.44299L9.87017 16.9116L6.16516 13.0626" stroke="#377DFF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
      ...
      <button className={`mt-auto py-4 px-6 rounded-xl font-bold transition-all active:scale-95 ${
        isHighlighted 
