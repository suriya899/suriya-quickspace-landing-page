...
function FeatureCard({
  ...
  return (
    <div
      className={`
        rounded-2xl p-8 transition-all duration-300 h-full w-full flex flex-col
        ${
          isActive
    ...
    >
      ...
      <div
        className="w-[100px] h-[100px] rounded-2xl flex items-center justify-center mb-6 bg-opacity-20"
