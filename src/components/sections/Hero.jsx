...
export default function Hero() {
  return (
    // ── Section: Hero หลัก ─────────────────────────────────────────
    <section
      className="pt-32 pb-20 bg-gradient-to-b from-[#E4ECFF] to-[#EAF0FF00]"
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch pt-10 lg:pt-20">
          ...
          <div className="flex flex-col items-center lg:items-start justify-end gap-6 order-2 lg:order-1 pb-1 lg:pb-2">
            {/* Badge */}
            <span
              className="inline-flex items-center bg-indigo-50 text-indigo-500
            ...
            <p className="text-gray-500 text-lg leading-relaxed max-w-md text-center lg:text-left">
              Backed with vast experience and fully up to date, it helps
              Software offer the best in class, Prescription solution.
            </p>
          ...
          <div className="relative flex justify-center items-end order-1 lg:order-2 h-[450px] lg:h-[520px]">
            ...
            <div className="relative flex justify-center items-end w-full max-w-[450px]">
              ...
              <div
                className="absolute left-[2%] -top-[10px] lg:left-[-5%] lg:-top-[25px]
              ...
              >
                ...
                <div className="relative flex-shrink-0">
                  <div
                    className="w-10 h-10 lg:w-11 lg:h-11 rounded-full absolute -left-6 -top-9
              ...
              <div
                className="absolute right-[-5%] bottom-[30%] lg:right-[-22%] lg:bottom-[20%]
              ...
              >
                ...
                <div>
                  <p className="text-[10px] lg:text-xs font-bold text-gray-800">
                    Gavin Henry
                  </p>
                  <p className="text-[8px] lg:text-[10px] text-gray-400">
                    1m ago
                  </p>
                </div>
                <span
              ...
              <div
                className="absolute left-[-2%] bottom-[5%] lg:left-[-3%] lg:bottom-[-6%]
                              bg-white rounded-2xl px-4 py-3 flex items-center gap-3
                              z-20 scale-90 lg:scale-100"
              >
                <div
                  className="w-10 h-10 lg:w-[50px] lg:h-[50px] rounded-full flex-shrink-0
